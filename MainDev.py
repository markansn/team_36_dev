...
realDataPath = "C:/Users/liu87/Desktop/UN project/Python 3.7 code src/image/FinFinal.jpg"
...
print("analysis:", ConvertToJSON(OCR2KeyPhrasesReFormatter(new_analysis)))
